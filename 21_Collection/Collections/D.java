...
/*here we are another method sort ehich is two parametrized one we are parsing the list which we want to sort and other comparator
on the basis of which we sort*/