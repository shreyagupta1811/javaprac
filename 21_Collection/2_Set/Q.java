...
//the most imp point regarding the comparatotr class is that the class on whose property we have to use compare () not compulsory to 
//have its sourcecode without its sourcecode we have access it.